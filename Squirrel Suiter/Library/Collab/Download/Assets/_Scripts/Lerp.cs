...
public class Lerp : MonoBehaviour {
    ...
    void Start()
    {
        ...
        //myZ = playerz;
        startTime = Time.time;
        randomIndex = Random.Range(60, 440);
        randomIndex2 = Random.Range(50, 100);
    ...
    void FixedUpdate()
    {
        ...
        Vector3 from = new Vector3(randomIndex, -60, transform.position.z);
        Vector3 to = new Vector3(randomIndex, randomIndex2, transform.position.z);
