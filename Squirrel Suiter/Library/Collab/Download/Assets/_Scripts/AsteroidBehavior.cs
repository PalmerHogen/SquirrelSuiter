...
public class AsteroidBehavior : MonoBehaviour {
	...
	void Start () {
		...
		if (squirrelTransform.position.z < 10.0f) {
			...
			startPos = new Vector3 (Random.Range (-50.0f, 550.0f), 300.0f, squirrelTransform.position.z + 500.0f + squirrelSpeed * 1.75f);
			destination = squirrelTransform.position + new Vector3(0, -squirrelTransform.position.y, 300.0f);
		}
		falling.Play ();
	}
